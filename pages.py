...
class EmployeeCardPage(BasePage):
    ...
    def last_name(self, value):
        self.set_text(EmployeeCardLocators.last_name, value, "Фамилия")

    def first_name(self, value):
        self.set_text(EmployeeCardLocators.first_name, value, "Имя")

    def middle_name(self, value):
        self.set_text(EmployeeCardLocators.middle_name, value, "Отчество")
...
class AccountInfoPage(BasePage):
    ...
    def salary_amount(self, value):
        self.set_text(AccountInfoLocators.salary_amount, value, "Сумма оклада")

    def working_hours(self, value):
        self.set_text(AccountInfoLocators.working_hours, value, "Продолжительность рабочего дня")
    ...
    def last_payroll(self, value):
        self.set_text(AccountInfoLocators.last_payroll, value, "Последний расчет зарплаты")
    ...
    def dismissal_number(self, value):
        self.set_text(AccountInfoLocators.dismissal_number, value, "Номер приказа об увольнении")
    ...
    def employee_number(self, value):
        self.set_text(AccountInfoLocators.employee_number, value, "Табельный номер замещающего")
...
class CalcInfoPage(BasePage):
    ...
    def note(self, value):
        self.set_text(CalcInfoLocators.note, value, "Примечание")

    def sick_days_percent(self, value):
        self.set_select(value, "Процент больничного")

    def average_daily_earnings(self, value):
        self.set_text(CalcInfoLocators.average_daily_earnings, value, "Среднедневной заработок (CP1)")

    def privileges_type(self, value):
        self.set_select(value, "Тип льгот на сотрудника")

    def coefficient(self, value):
        self.set_text(CalcInfoLocators.coefficient, value, "Районный коэффициент")
    ...
    def chaes_number(self, value):
        self.set_text(CalcInfoLocators.chaes_number, value, "Номер удостоверения участника ЧАЭС")
    ...
    def card_number(self, value):
        self.set_text(CalcInfoLocators.card_number, value, "Номер карты/счета в банке")
    ...
    def key(self, value):
        self.set_text(CalcInfoLocators.key, value, "Ключ")
...
class EmployeePrivilegesPage(BasePage):
    ...
    def child_number(self, value):
        self.set_text(EmployeePrivilegesLocators.child_number, value, "Порядковый номер ребенка")

    def statement_number(self, value):
        self.set_text(EmployeePrivilegesLocators.statement_number, value, "Номер заявления")
    ...
    def note(self, value):
        self.set_text(EmployeePrivilegesLocators.note, value, "Примечание")

    def privileges_amount(self, value):
        self.set_text(EmployeePrivilegesLocators.privileges_amount, value,
    ...
    def deduction_sum(self, value):
        self.set_text(EmployeePrivilegesLocators.deduction_sum, value, "Сумма имущественного/социального вычета")

    def imns(self, value):
        self.set_text(EmployeePrivilegesLocators.imns, value, "ИМНС (для имущественного/социального вычета)")
...
class DocumentsPage(BasePage):
    ...
    def serial_number(self, value1, value2, value3):
        self.set_text(DocumentsLocators.serial_first, value1, "Серия 1")
        self.set_text(DocumentsLocators.serial_second, value2, "Серия 2")
        self.set_text(DocumentsLocators.serial_third, value3, "Номер")

    def department_code(self, value):
        self.set_text(DocumentsLocators.department_code, value, "Код подразделения")

    def issue_date(self, value):
        self.set_date(DocumentsLocators.issue_date, value, "Дата выдачи")

    def issued_by(self, value):
        self.set_text(DocumentsLocators.issued_by, value, "Выдан")
...
class AddressesPage(BasePage):
    ...
    def index(self, value):
        self.set_text(AddressesLocators.index, value, "Индекс")

    def region(self, value):
        self.set_text(AddressesLocators.region, value, "Регион")

    def area(self, value):
        self.set_text(AddressesLocators.area, value, "Район")

    def area_type(self, value):
        self.set_type(AddressesLocators.area_type, value, "Тип района")

    def city(self, value):
        self.set_text(AddressesLocators.city, value, "Город")

    def city_type(self, value):
        self.set_type(AddressesLocators.city_type, value, "Тип города")

    def locality(self, value):
        self.set_text(AddressesLocators.locality, value, "Населенный пункт")

    def locality_type(self, value):
        self.set_type(AddressesLocators.locality_type, value, "Тип населенного пункта")

    def street(self, value):
        self.set_text(AddressesLocators.street, value, "Улица")

    def street_type(self, value):
        self.set_type(AddressesLocators.street_type, value, "Тип улицы")

    def building(self, value):
        self.set_text(AddressesLocators.building, value, "Дом")

    def block(self, value):
        self.set_text(AddressesLocators.block, value, "Корпус")

    def apartment(self, value):
        self.set_text(AddressesLocators.apartment, value, "Квартира")

    def use(self, value):
        self.set_checkbox(AddressesLocators.use, value, "Использовать КЛАДР")

    def actual_address(self, value):
        self.set_text(AddressesLocators.actual_address, value, "Адрес фактического проживания")
...
class PFRPage(BasePage):
    ...
    def registration_number(self, value):
        self.set_text(PFRLocators.registration_number, value, "Регистрационный номер в ПФ")
    ...
    def last_name(self, value):
        self.set_text(PFRLocators.last_name, value, "Фамилия для ПФ")

    def first_name(self, value):
        self.set_text(PFRLocators.first_name, value, "Имя для ПФ")

    def middle_name(self, value):
        self.set_text(PFRLocators.middle_name, value, "Отчество для ПФ")
    ...
    def country(self, value):
        self.set_text(PFRLocators.country, value, "Страна")

    def region(self, value):
        self.set_text(PFRLocators.region, value, "Область")

    def area(self, value):
        self.set_text(PFRLocators.area, value, "Район")

    def city(self, value):
        self.set_text(PFRLocators.city, value, "Город/село")
...
class FNSPage(BasePage):
    ...
    def itn(self, value):
        self.set_text(FNSLocators.itn, value, "ИНН")
...
class DisabledCardPage(BasePage):
    ...
    def full_name(self, value):
        self.wait.element_appear(DisabledCardLocators.full_name).find_element(By.XPATH, ".//following-sibling::*[1]/button[2]").click()
        self.wait.element_appear((By.XPATH, "//div[@class='w2ui-col-header ' and contains(., 'Имя')]"))
        self.set_type_alt(value, "Фамилия И.О.")

    def reference(self, value):
        self.set_text(DisabledCardLocators.reference, value, "Справка учреждения медико-социальной экспертизы")
...
class OtherPage(BasePage):
    ...
    def phone_number(self, value):
        self.set_text(OtherLocators.phone_number, value, "Телефон")

    def email(self, value):
        self.set_text(OtherLocators.email, value, "E-Mail")
...
class PayrollCardPage(BasePage):
    ...
    def payroll_sum(self, value):
        self.set_text(PayrollCardLocators.payroll_sum, value, "Сумма начисления")

    def average_income_sum(self, value):
        self.set_text(PayrollCardLocators.average_income_sum, value, "Сумма среднего заработка")
    ...
    def parameters(self, data):
        for i in range(9):
            self.set_text(PayrollCardLocators.parameters[i], data[i], "Заполнение %s параметра" % i)
...
class WithholdingCardPage(BasePage):
    ...
    def order(self, value):
        self.set_text(WithholdingCardLocators.order, value, "Приказ")

    def withholding_sum(self, value):
        self.set_text(WithholdingCardLocators.withholding_sum, value, "Сумма удержания")
    ...
    def parameters(self, data):
        for i in range(9):
            self.set_text(WithholdingCardLocators.parameters[i], data[i], "Заполнение %s параметра" % i)

    def payment_accruals(self, value):
        self.set_text(WithholdingCardLocators.payment_accruals, value, "Межвыплата по начислениям")
...
class StatementCardPage(BasePage):
    ...
    def full_name(self, value):
        self.set_text(StatementCardLocators.full_name, value, "От сотрудника")
    ...
    def insurer(self, value):
        self.set_text(StatementCardLocators.insurer, value, "У страхователя")

    def reason(self, value):
        self.set_text(StatementCardLocators.reason, value, "Причина невозможности получить справку")
...
class PFRequestCardPage(BasePage):
    ...
    def unit(self, value):
        self.wait.loading()
        self.set_text(PFRequestCardLocators.unit, value, "В территориальный орган ПФР")

    def additional(self, value):
        self.set_text(PFRequestCardLocators.additional, value, "Дополнительные сведения о страховке")

    def full_name(self, value):
        self.set_text(PFRequestCardLocators.full_name, value, "По заявлению сотрудника")

    def year_first(self, value):
        self.set_text(PFRequestCardLocators.year_first, value, "Годы работы первое поле")

    def year_second(self, value):
        self.set_text(PFRequestCardLocators.year_second, value, "Годы работы второе поле")

    def year_third(self, value):
        self.set_text(PFRequestCardLocators.year_third, value, "Годы работы третье поле")

    def insurer(self, value):
        self.set_text(PFRequestCardLocators.insurer, value, "У страхователя")

    def reason(self, value):
        self.set_text(PFRequestCardLocators.reason, value, "Причина невозможности получить справку")
...
class FSSRequestCardPage(BasePage):
    ...
    def unit(self, value):
        self.set_text(FSSRequestCardLocators.unit, value, "В территориальный орган ФСС")

    def full_name(self, value):
        self.set_text(FSSRequestCardLocators.full_name, value, "Для оплаты сотруднику")

    def type(self, value):
        self.set_select(value, "Вид пособия")

    def first_employer(self, value):
        self.set_text(FSSRequestCardLocators.first_employer, value, "Первый работодатель")

    def first_itn(self, value):
        self.set_text(FSSRequestCardLocators.first_itn, value, "ИНН первого работодателя")

    def first_unit(self, value):
        self.set_text(FSSRequestCardLocators.first_unit, value, "Терриориальный орган первого работодателя")

    def first_kpp(self, value):
        self.set_text(FSSRequestCardLocators.first_kpp, value, "КПП первого работодателя")

    def first_registration_number(self, value):
        self.set_text(FSSRequestCardLocators.first_registration_number, value,
                      "Регистрационный номер первого работодателя")

    def first_additional_code(self, value):
        self.set_text(FSSRequestCardLocators.first_additional_code, value, "Дополнительный код первого работодателя")

    def first_code(self, value):
        self.set_text(FSSRequestCardLocators.first_code, value, "Код подчиненного первого работодателя")
    ...
    def second_employer(self, value):
        self.set_text(FSSRequestCardLocators.second_employer, value, "Второй работодатель")

    def second_itn(self, value):
        self.set_text(FSSRequestCardLocators.second_itn, value, "ИНН второго работодателя")

    def second_unit(self, value):
        self.set_text(FSSRequestCardLocators.second_unit, value, "Территориальный орган второго работодателя")

    def second_kpp(self, value):
        self.set_text(FSSRequestCardLocators.second_kpp, value, "КПП второго работодателя")

    def second_registration_number(self, value):
        self.set_text(FSSRequestCardLocators.second_registration_number, value,
                      "Регистрационный номер второго работодателя")

    def second_additional_code(self, value):
        self.set_text(FSSRequestCardLocators.second_additional_code, value, "Дополнительный код второго работодателя")

    def second_code(self, value):
        self.set_text(FSSRequestCardLocators.second_code, value, "Код подчиненного второго работодателя")
    ...
    def third_employer(self, value):
        self.set_text(FSSRequestCardLocators.third_employer, value, "Третий работодатель")

    def third_itn(self, value):
        self.set_text(FSSRequestCardLocators.third_itn, value, "ИНН третьего работодателя")

    def third_unit(self, value):
        self.set_text(FSSRequestCardLocators.third_unit, value, "Территориальный орган третьего работодателя")

    def third_kpp(self, value):
        self.set_text(FSSRequestCardLocators.third_kpp, value, "КПП третьего работодателя")

    def third_registration_number(self, value):
        self.set_text(FSSRequestCardLocators.third_registration_number, value,
                      "Регистрационный номер третьего работодателя")

    def third_additional_code(self, value):
        self.set_text(FSSRequestCardLocators.third_additional_code, value, "Дополнительный код третьего работодателя")

    def third_code(self, value):
        self.set_text(FSSRequestCardLocators.third_code, value, "Код подчиненного третьего работодателя")
...
class FTNCardPage(BasePage):
    ...
    def base(self, value):
        self.set_text(FTNCardLocators.base, value, "Облагаемая база")

    def discount(self, value):
        self.set_text(FTNCardLocators.discount, value, "Скидка")

    def privilege(self, value):
        self.set_text(FTNCardLocators.privilege, value, "Льготы")

    def material_assistance(self, value):
        self.set_text(FTNCardLocators.material_assistance, value, "Материальная помощь")

    def amount(self, value):
        self.set_text(FTNCardLocators.amount, value, "Количество детей")
...
class FSTNCardPage(BasePage):
    ...
    def base(self, value):
        self.set_text(FSTNCardLocators.base, value, "Облагаемая база")

    def disabled_base(self, value):
        self.set_text(FSTNCardLocators.disabled_base, value, "Облагаемая база инвалида")

    def discount(self, value):
        self.set_text(FSTNCardLocators.discount, value, "Скидка")

    def deductions(self, value):
        self.set_text(FSTNCardLocators.deductions, value, "Отчисления")

    def disabled_deductions(self, value):
        self.set_text(FSTNCardLocators.disabled_deductions, value, "Отчисления инвалиду")

    def material_assistance(self, value):
        self.set_text(FSTNCardLocators.material_assistance, value, "Материальная помощь")

    def amount(self, value):
        self.set_text(FSTNCardLocators.amount, value, "Количество детей")
...
class IncomeCertificatePage(BasePage):
    ...
    def tax_sum(self, value):
        self.set_text(IncomeCertificateLocators.tax_sum, value, "Сумма налога")

    def income_sum(self, value):
        self.set_text(IncomeCertificateLocators.income_sum, value, "Сумма")

    def income_type(self, value):
        self.set_type(IncomeCertificateLocators.income_type, value, "Тип дохода")

    def deduction_sum(self, value):
        self.set_text(IncomeCertificateLocators.deduction_sum, value, "Сумма")
    ...
    def childs_amount(self, value):
        self.set_text(IncomeCertificateLocators.childs_amount, value, "Количество детей")
...
class ReferencePreviousPlacePage(BasePage):
    ...
    def reference_number(self, value):
        self.set_text(ReferencePreviousPlaceLocators.reference_number, value, "Номер справки")

    def insurer(self, value):
        self.set_text(ReferencePreviousPlaceLocators.insurer, value, "Страхователь")
    ...
    def salary_year(self, value):
        self.set_text(ReferencePreviousPlaceLocators.salary_year, value, "Год")

    def salary_sum(self, value):
        self.set_text(ReferencePreviousPlaceLocators.salary_sum, value, "Сумма заработка")
    ...
    def days_year(self, value):
        self.set_text(ReferencePreviousPlaceLocators.days_year, value, "Год")
    ...
    def days_amount(self, value):
        ...
        self.wait.loading()
        self.set_text(ReferencePreviousPlaceLocators.days_amount, value, "Исключаемые дни")
